...
export function renderSheet(page) {
    ...
    const basicsRows = ['plains', 'island', 'swamp', 'mountain', 'forest']
    ...
    const p = page.player ?? {};
    const playedSum = page.rows.reduce((s, r) => s + (r.played ?? 0), 0) +
